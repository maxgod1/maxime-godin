...
export default function Stack() {
  ...
  return (
    <div className="flex flex-col items-center mx-auto max-w-[1200px] w-full">
      <p className="lg:text-3xl text-2xl font-bold mb-10 mt-10 px-4 text-center">{strings.the_tech_i_use}</p>
      <div className="flex flex-wrap items-center justify-center lg:gap-24 gap-14 lg:px-2 px-3 py-14 w-fit mx-auto">
        {logos.map((l) => (
